...
export default async function NewProposalPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <PageHeader eyebrow="Commercial" title="New proposal" description="Set out Tide’s approach, scope and assumptions, then publish it to the client portal." />
      <Card><CardContent><form action={createProposal} className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="space-y-1.5 sm:col-span-2"><Label htmlFor="title">Proposal title</Label><Input id="title" name="title" required /></div>
        ...
        <div className="space-y-1.5 sm:col-span-2"><Label htmlFor="summary">Executive summary</Label><Textarea id="summary" name="summary" rows={4} /></div>
        <div className="space-y-1.5 sm:col-span-2"><Label htmlFor="scope">Proposed scope</Label><Textarea id="scope" name="scope" rows={7} /></div>
        <div className="space-y-1.5 sm:col-span-2"><Label htmlFor="assumptions">Assumptions and exclusions</Label><Textarea id="assumptions" name="assumptions" rows={4} /></div>
        ...
        <Button type="submit" className="w-fit sm:col-span-2">Create proposal</Button>
